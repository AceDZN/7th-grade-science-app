...
const SIMULATION_REGISTRY: Record<string, React.ComponentType<any>> = {
    VolumeSimulation,
    DisplacementSimulation,
    GravitySimulation,
    FloatingExperiment,
...
export const DynamicSimulation = ({ block }: { block: SimulationBlock }) => {
    ...
    if (!Component) {
        return <div className="p-4 bg-red-100 text-red-600 rounded-xl">Simulation "{block.componentName}" not found</div>;
    }
